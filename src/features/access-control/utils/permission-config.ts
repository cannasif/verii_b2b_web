export const ROUTE_PERMISSION_MAP: Record<string, string> = {
  ...
  '/b2b/payment-settings': 'b2b.payment-settings.view',
...
export const PATH_TO_PERMISSION_PATTERNS: Array<{ pattern: RegExp; permission: string }> = [
  ...
  { pattern: /^\/b2b\/payment-settings(\/|$)/, permission: 'b2b.payment-settings.view' },
...
export const PERMISSION_SCOPE_DISPLAY: Record<string, PermissionScopeDisplay> = {
  ...
  'b2b.payment-settings': { key: 'sidebar.b2bPaymentSettings', fallback: 'Ödeme Ayarları' },
