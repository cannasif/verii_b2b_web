...
export const b2bApi = {
  ...
  selectPaymentProviderInstallmentByLinkToken: paymentApi.selectPaymentProviderInstallmentByLinkToken,
  resolvePaymentMethods: paymentApi.resolvePaymentMethods,
  resolvePaymentMethodsByLinkToken: paymentApi.resolvePaymentMethodsByLinkToken,
  createPayment: paymentApi.createPayment,
  lookupPaymentBin: paymentApi.lookupPaymentBin,
  lookupPaymentBinByLinkToken: paymentApi.lookupPaymentBinByLinkToken,
  getPaymentInstallmentOptions: paymentApi.getPaymentInstallmentOptions,
  getPaymentInstallmentOptionsByLinkToken: paymentApi.getPaymentInstallmentOptionsByLinkToken,
