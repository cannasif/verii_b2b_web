...
import { configs, editSupportedKinds, kindByRouteSlug, routeSlugByKind, type B2bWorkspacePageKind } from './b2bWorkspaceConfig';
  ...
  'marketplace-channels': {
    ...
    fields: [
      { name: 'providerKey', label: 'Pazar Yeri', type: 'select', required: true, options: [
        ...
        { label: 'Adobe Commerce', value: 'AdobeCommerce' },
